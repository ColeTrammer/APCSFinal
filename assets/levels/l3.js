...
manager.spawn(new Wall(
    w1Rect,
    new SimpleHarmonicOscillation(w1Rect, 1 / 6 * C.WORLD_WIDTH - C.PLAYER_WIDTH / 2, C.WORLD_HEIGHT / 2, 0, C.WORLD_HEIGHT / 2 - 2 * C.PLAYER_HEIGHT, k)));
var w2Rect = new Rectangle(2 / 6 * C.WORLD_WIDTH + 20, C.PLAYER_JUMP_HEIGHT - player.getHeight(), 100, 20);
manager.spawn(new OneWayWall(
    w2Rect,
    new SimpleHarmonicOscillation(w2Rect, 2 / 6 * C.WORLD_WIDTH - 20 + (C.WORLD_WIDTH - 100 - (2 / 6 * C.WORLD_WIDTH - 20)) / 2, C.PLAYER_JUMP_HEIGHT - player.getHeight() + 10, (C.WORLD_WIDTH - 100 - (2 / 6 * C.WORLD_WIDTH - 20)) / 2, 0, 0.91375),
    Direction.DOWN));
